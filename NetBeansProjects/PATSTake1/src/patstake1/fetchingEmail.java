...
public class fetchingEmail {
    ...
    private static ArrayList<String> emailsArray = new ArrayList<>();
...
//      Message[] messages = emailFolder.getMessages();
      ...
      for (int i = 0, n = messages.length; i < n; i++) {
         ...
         if (message.getContent().toString().contains("Multipart")) {
    ...
    else if (message.getContent().toString().contains("text/plain")
            || message.getContent().toString().contains("text/html")) {
