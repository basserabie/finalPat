...
public class fetchStudentDetails {//creates a class representing a student object
    ...
    private String fName, lName, grade;//creates string for the first name, last name, and grade of the student object
        // in: student id, schoolid, mother id, firstname, lastname, grade of student
    ...
    public void setSchoolID(int schoolID) {//creates a method to set the schoolID in: student school id to set to
    ...
    public void setMotherID(int motherID) {//creates a method to set the motherID in: student mother id to set to
    ...
    public void setfName(String fName) {//creates a method to set the fName in: student first name to set to
    ...
    public void setlName(String lName) {//creates a method to set the lName in: student last name to set to
    ...
    public void setGrade(String grade) {//creates a method to set the grade in: student grade to set to
